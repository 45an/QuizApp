...
namespace QuizApp.Server.Data.Migrations
{
    ...
    [Migration("20240414154743_Answer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("QuizApp.Server.Models.Answer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizApp.Server.Models.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("QuizApp.Server.Models.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuizApp.Server.Models.Media", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("QuizApp.Server.Models.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("QuizApp.Server.Models.Answer", b =>
                {
                    b.HasOne("QuizApp.Server.Models.Quiz", "AnswerQuiz")
                        .WithMany()
                        .HasForeignKey("AnswerQuizId");

                    b.HasOne("QuizApp.Server.Models.Quiz", "OriginalQuiz")
                        .WithMany()
                        .HasForeignKey("OriginalQuizId");
            ...
            modelBuilder.Entity("QuizApp.Server.Models.Game", b =>
                {
                    b.HasOne("QuizApp.Server.Models.Answer", "Answer")
                        .WithMany()
